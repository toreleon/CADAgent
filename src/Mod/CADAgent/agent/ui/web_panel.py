...
# Resolve Resources/web/index.html relative to the Mod/CADAgent directory
# (three parents up from this file: ui/ → agent/ → CADAgent/).
_HERE = os.path.dirname(os.path.abspath(__file__))
_WEB_INDEX = os.path.abspath(
    os.path.join(_HERE, "..", "..", "Resources", "web", "index.html")
)
